...
public class PlayerMovement : MonoBehaviour {
	...
	void Update () {
		...
		Vector3 velocity = new Vector3(Input.GetAxis("Horizontal") * maxHSpeed * Time.deltaTime, Input.GetAxis("Vertical") * maxSpeed * Time.deltaTime, 0);
